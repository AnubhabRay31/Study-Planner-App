...
public class CustomAdapterAS extends RecyclerView.Adapter<CustomAdapterAS.MyViewHolder> {
    ...
    public CustomAdapterAS(Activity activity,Context context,
                         ArrayList event_id,
    ...
    @Override
    public void onBindViewHolder(@NonNull @org.jetbrains.annotations.NotNull CustomAdapterAS.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
...
//        holder.event_type_txt.setText(String.valueOf(event_type.get(position)));
        ...
        holder.rowLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,UpdateActivityAS.class);
